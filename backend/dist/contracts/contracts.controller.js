...
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.Permissions)('contratos.create'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.Permissions)('contratos.read'),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, permissions_decorator_1.Permissions)('contratos.update'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('contratos.delete'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
